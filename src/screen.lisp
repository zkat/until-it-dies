...
(defsheep =screen= ()
  ...
  (:documentation
"Screens are objects that contain components. They are rendered in
...
UPDATE and DRAW messages to any attached components. 

Screens are meant to be containers for entire blocks of app execution, 
and can be loaded from file scripts (ideally without affecting the
rest of the world)."))
